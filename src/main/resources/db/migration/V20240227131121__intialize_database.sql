...
(
    ...
    CONSTRAINT FK_FACAULTY FOREIGN KEY (FACULTY_ID) REFERENCES GWBACKEND.FACULTY(ID)
);

ALTER TABLE GWBACKEND.FACULTY
ADD CONSTRAINT FK_MANAGER FOREIGN KEY (MANAGER_ID) REFERENCES GWBACKEND.USERS(ID);
...
(
    ...
    CONSTRAINT FK_SUBMISSION_PERIOD_ID FOREIGN KEY (SUBMISSION_PERIOD_ID) REFERENCES GWBACKEND.SUBMISSION_PERIOD(ID)
);
